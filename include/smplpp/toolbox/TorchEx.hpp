...
private: // PRIVATE ATTRIBUTES
  ...
  static torch::Tensor indexing_impl(torch::Tensor & self, int64_t layer, Array index, Rest... indices) noexcept(false);

  template<class Array>
  static torch::Tensor indexing_impl(torch::Tensor & self, int64_t layer, Array index) noexcept(false);
...
public: // PUBLIC ATTRIBUTES
  ...
  static torch::Tensor indexing(torch::Tensor & self, Arrays... indices) noexcept(false);
};
 ...
 */
template<class... Arrays>
torch::Tensor TorchEx::indexing(torch::Tensor & self, Arrays... indices) noexcept(false)
{
  torch::Tensor out;
  try
  {
